 ...
 * @param mode 房间模式
 */
- (void)onRoomSpeechModeChanged:(NSString *)roomId speechMode:(TUISpeechMode)mode NS_SWIFT_NAME(onRoomSpeechModeChanged(roomId:speechMode:))__attribute__((deprecated("Deprecated from v2.0")));
 ...
 */
- (void)onRequestProcessed:(NSString *)requestId userId:(NSString *)userId NS_SWIFT_NAME(onRequestProcessed(requestId:userId:));
